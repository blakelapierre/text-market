...
CREATE TABLE "income"."translation" ("id" bigserial, "insert_at" timestamp DEFAULT now() NOT NULL, "tax_id" bigserial NOT NULL REFERENCES "income"."tax", "exchange_id" bigserial NOT NULL REFERENCES "income"."exchange", PRIMARY KEY ("id"));
