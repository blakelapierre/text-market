...
CREATE TABLE "income"."transaction" ("id" bigserial, "insert_at" timestamp DEFAULT now() NOT NULL, "info_id" bigserial REFERENCES "income"."info", "item_id" bigserial NOT NULL REFERENCES "income"."item", "tax_amount" bigserial NOT NULL REFERENCES "income"."tax", "income_amount" bigserial NOT NULL REFERENCES "income"."income", PRIMARY KEY ("id"));
